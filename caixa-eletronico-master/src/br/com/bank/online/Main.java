...
public class Main {
    ...
    static {
        clientes[0] = new Cliente("William", "William", "William");
        clientes[1] = new Cliente("teste", "teste", "teste");
    }
    ...
    public static void main(String[] args) {
        ...
        //INICIO DO PROGRAMA
        System.out.println("================================================");
        System.out.println(" BEM VINDO AO CAIXA ELETRONICO DA WARZONE BANK	");
        System.out.println("================================================");
        System.out.println();
            ...
            switch (numberChoosen) {
                case 1:
                    ...
                    for (Cliente cliente : clientes) {
                        if (cliente != null) {
                            System.out.println("Posicao: " + count + " - " + cliente);
                            count++;
                        } else {
                            System.out.println("		NAO HA NENHUM CLIENTE CADASTRADO NESTA POSICAO				");

                        }
                    }

                    System.out.println("Digite a posicao referente ao seu login ou digite '05' para sair");
